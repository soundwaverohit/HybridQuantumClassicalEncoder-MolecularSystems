module read_ham
    ...
    function test_annihilation(N, seed, circuit, mu)
        annihilation_fname =  "/Users/rohitganti/Desktop/HybridQuantumClassicalEncoder-MolecularSystems/SYK_Hamiltonian_HA_Model/SYK_Implementation_of_TFD_VQE/data/SYK_annihilator_$(N)_$(seed)_$(@sprintf("%.2f", mu)).txt"
